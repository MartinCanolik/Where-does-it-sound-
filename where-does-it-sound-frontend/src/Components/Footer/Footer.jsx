                    ...
                    <footer className="md:flex md:items-center md:justify-between md:p-4">
                        ...
                        <div>
                            <div className="flex flex-col justify-center items-center mx-auto gap-4">
                                ...
                                <p className="text-white">
                                    © DondeSuena {new Date().getFullYear()} -
                                    Made with ♫ by{" "}
                                    <Link
                                        to={"/team"}
                                        className="hover:text-customRed font-bold transition duration-200 ease-in-out"
                                    >
                                        Los Magios
                                    </Link>
                                    .
                        ...
                        <ul className="flex flex-wrap items-center text-base mr-6">
                            <li>
                                <a
                                    href="/team"
                                    className="text-white italic font-bold border-b-2 border-transparent px-4 py-2 hover:text-customRed hover:border-customRed transition duration-500 ease-in-out"
                                >
                                    About us
                                </a>
                            </li>
